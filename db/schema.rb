...
ActiveRecord::Schema.define(version: 2020_10_23_021116) do
  ...
  create_table "prototypes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
